...
ready: true
tools: [read, read_document, write, edit, find, grep, ls, web_search, web_fetch, present_files, questionnaire, todo_write, task, read_me, show_widget, powershell, automation_create, automation_list, automation_delete, docx_convert, conversation_search]
---
