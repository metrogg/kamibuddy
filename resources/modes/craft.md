...
ready: true
tools: [read, read_document, write, edit, find, grep, ls, web_search, web_fetch, present_files, questionnaire, powershell, automation_create, automation_list, automation_delete, task]
---
