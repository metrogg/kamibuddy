...
ready: true
tools: [read, read_document, write, edit, find, grep, ls, web_search, web_fetch, present_files, questionnaire, read_me, show_widget, powershell, automation_create, automation_list, automation_delete]
---
