...
> **本地化说明（搬运自 WorkBuddy 专家团包）**：
> 1. 你完成一轮后的**最终回复会自动回投给主理人**，不需要你主动发消息；
...
4. **信息回传**：竞品信息、用户画像、功能优先级通过 自动回投 回传给主理人，由主理人中转给架构师和设计师。
...
完成任务后，必须通过 自动回投 将产出结果回传给主理人（大湾区靓仔）。
