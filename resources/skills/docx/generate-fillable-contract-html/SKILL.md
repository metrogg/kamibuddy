...
<!-- 来源：WorkBuddy `tencent-docx` 插件 `skills/generate-fillable-contract-html`，搬入日期 2026-09-17。
     正文原样搬用；仅将指向 WorkBuddy 工具名的 `html-to-docx` 改为本项目的 `docx_convert` 工具。
     内部阶段原样搬用，正式上线前由专人做风险置换（AGENTS.md §6）。 -->
