...
var en_US_default = {
	...
	connectors: {
		"runtime": {
			...
			"installing": "Installing connector dependencies for first use or update. Please wait…",
			"prepareFailed": "Failed to prepare connector runtime",
			"installFailed": "Failed to install connector dependencies",
	...
	menu: {
		...
		"traceIdCopiedDetail": "Copied: {{traceId}}",
		"traceIdNotAvailableDetail": "No startup Trace ID is available yet.",
		"okButton": "OK"
	},
	window: {
		"maximize": "Maximize",
	...
	terminal: {
		...
		"new": "New",
		"name": "Terminal",
		"unavailable": "Local terminal is unavailable in this environment",
		"limitExceeded": "The terminal limit has been reached. You can have up to {{limit}} terminals. Close some terminals and try again."
	},
	windowLifecycle: {
		"activeTasksQuit": {
			"cancel": "Cancel",
		...
		"taskCompleted": {
			...
			"body": "Task completed successfully. Click to view the result"
		},
		"taskPending": {
			"title": "Task Confirmation Required",
			"body": "An action requires your confirmation. Click to view"
		}
	}
};
var zh_CN_default = {
	...
	connectors: {
		"runtime": {
			...
			"installing": "首次使用或更新需要安装连接器依赖，正在安装中，请稍后…",
			"prepareFailed": "连接器运行环境准备失败",
			"installFailed": "连接器依赖安装失败",
	...
	menu: {
		...
		"traceIdCopiedDetail": "已复制：{{traceId}}",
		"traceIdNotAvailableDetail": "当前还没有启动 Trace ID，请等待启动遥测上报后再试。",
		"okButton": "确定"
	},
	window: {
		"maximize": "最大化",
	...
	terminal: {
		...
		"new": "新建",
		"name": "Terminal",
		"unavailable": "当前环境不支持本地终端",
		"limitExceeded": "终端数量已达上限，最多可创建 {{limit}} 个。请关闭部分终端后重试。"
	},
	windowLifecycle: {
		"activeTasksQuit": {
			"cancel": "取消",
		...
		"taskCompleted": {
			"title": "任务已完成",
			"body": "任务已成功完成，请点击查看结果"
		},
		"taskPending": {
			"title": "任务操作待您确认",
			"body": "任务有操作需要您的确认，请点击查看"
		}
	}
};
//#endregion
...
var menuTranslations = {
	"zh-CN": {
		...
		copyStartupTraceId: "复制启动 Trace ID",
		openStartupReport: "启动报告",
		traceIdDialogTitle: "复制启动 Trace ID",
		traceIdCopiedDetail: "已复制：{traceId}",
		traceIdNotAvailableDetail: "当前还没有启动 Trace ID，请等待启动遥测上报后再试。",
	...
	"en-US": {
		...
		copyStartupTraceId: "Copy Startup Trace ID",
		openStartupReport: "Startup Report",
		traceIdDialogTitle: "Copy Startup Trace ID",
		traceIdCopiedDetail: "Copied: {traceId}",
		traceIdNotAvailableDetail: "No startup Trace ID is available yet.",
