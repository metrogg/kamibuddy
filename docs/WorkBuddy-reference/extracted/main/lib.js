...
const require_safer$1 = require("./safer.js");
...
var require_internal = /* @__PURE__ */ require_chunk.__commonJSMin(((exports, module) => {
	var Buffer = require_safer$1.require_safer().Buffer;
	module.exports = {
		utf8: {
			type: "_internal",
			bomAware: true
...
var shiftjis_exports = /* @__PURE__ */ require_chunk.__exportAll({ default: () => shiftjis_default });
var shiftjis_default;
var init_shiftjis = require_chunk.__esmMin((() => {
...
var eucjp_exports = /* @__PURE__ */ require_chunk.__exportAll({ default: () => eucjp_default });
var eucjp_default;
var init_eucjp = require_chunk.__esmMin((() => {
...
var cp936_exports = /* @__PURE__ */ require_chunk.__exportAll({ default: () => cp936_default });
var cp936_default;
var init_cp936 = require_chunk.__esmMin((() => {
...
var gbk_added_exports = /* @__PURE__ */ require_chunk.__exportAll({ default: () => gbk_added_default });
var gbk_added_default;
var init_gbk_added = require_chunk.__esmMin((() => {
	gbk_added_default = [
		[
			"a140",
			"",
...
var gb18030_ranges_exports = /* @__PURE__ */ require_chunk.__exportAll({
	default: () => gb18030_ranges_default,
	gbChars: () => gbChars,
	uChars: () => uChars
});
var uChars, gbChars, gb18030_ranges_default;
var init_gb18030_ranges = require_chunk.__esmMin((() => {
	uChars = [
		128,
		165,
		169,
...
var cp949_exports = /* @__PURE__ */ require_chunk.__exportAll({ default: () => cp949_default });
var cp949_default;
var init_cp949 = require_chunk.__esmMin((() => {
...
var cp950_exports = /* @__PURE__ */ require_chunk.__exportAll({ default: () => cp950_default });
var cp950_default;
var init_cp950 = require_chunk.__esmMin((() => {
...
var big5_added_exports = /* @__PURE__ */ require_chunk.__exportAll({ default: () => big5_added_default });
var big5_added_default;
var init_big5_added = require_chunk.__esmMin((() => {
...
var require_dbcs_data = /* @__PURE__ */ require_chunk.__commonJSMin(((exports, module) => {
	module.exports = {
		"shiftjis": {
			type: "_dbcs",
			table: function() {
				return init_shiftjis(), require_chunk.__toCommonJS(shiftjis_exports).default;
			},
			encodeAdd: {
				"¥": 92,
				"‾": 126
		...
		"eucjp": {
			type: "_dbcs",
			table: function() {
				return init_eucjp(), require_chunk.__toCommonJS(eucjp_exports).default;
			},
			encodeAdd: {
				"¥": 92,
				"‾": 126
		...
		"cp936": {
			type: "_dbcs",
			table: function() {
				return init_cp936(), require_chunk.__toCommonJS(cp936_exports).default;
			}
		},
		"gbk": {
			type: "_dbcs",
			table: function() {
				return (init_cp936(), require_chunk.__toCommonJS(cp936_exports).default).concat((init_gbk_added(), require_chunk.__toCommonJS(gbk_added_exports).default));
			}
		},
		"xgbk": "gbk",
		"isoir58": "gbk",
		"gb18030": {
			...
			gb18030: function() {
				return init_gb18030_ranges(), require_chunk.__toCommonJS(gb18030_ranges_exports).default;
			},
			encodeSkipVals: [128],
			encodeAdd: { "€": 41699 }
		},
		...
		"cp949": {
			type: "_dbcs",
			table: function() {
				return init_cp949(), require_chunk.__toCommonJS(cp949_exports).default;
			}
		},
		"cseuckr": "cp949",
		"csksc56011987": "cp949",
		...
		"cp950": {
			type: "_dbcs",
			table: function() {
				return init_cp950(), require_chunk.__toCommonJS(cp950_exports).default;
			}
		},
		"big5": "big5hkscs",
		"big5hkscs": {
			type: "_dbcs",
			table: function() {
				return (init_cp950(), require_chunk.__toCommonJS(cp950_exports).default).concat((init_big5_added(), require_chunk.__toCommonJS(big5_added_exports).default));
			},
			encodeSkipVals: [
				36457,
				36463,
