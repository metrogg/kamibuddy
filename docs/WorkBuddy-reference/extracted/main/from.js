...
var init_fetch_blob = require_chunk.__esmMin((() => {
	require_streams();
	POOL_SIZE = 65536;
	_Blob = class Blob {
...
var _File, File;
var init_file = require_chunk.__esmMin((() => {
	init_fetch_blob();
...
var init_esm_min = require_chunk.__esmMin((() => {
	init_fetch_blob();
	init_file();
...
var init_from = require_chunk.__esmMin((() => {
