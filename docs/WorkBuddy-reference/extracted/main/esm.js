...
var _globalThis;
var init_globalThis = require_chunk.__esmMin((() => {
...
var init_node = require_chunk.__esmMin((() => {
	init_globalThis();
}));
//#endregion
...
var VERSION;
var init_version = require_chunk.__esmMin((() => {
	VERSION = "1.9.0";
}));
//#endregion
...
var re, isCompatible;
var init_semver = require_chunk.__esmMin((() => {
	init_version();
	re = /^(\d+)\.(\d+)\.(\d+)(-(.+))?$/;
...
var init_global_utils = require_chunk.__esmMin((() => {
	init_platform();
	init_version();
	init_semver();
...
var init_ComponentLogger = require_chunk.__esmMin((() => {
	init_global_utils();
...
var init_logLevelLogger = require_chunk.__esmMin((() => {
	init_types();
}));
//#endregion
...
var init_diag = require_chunk.__esmMin((() => {
...
var init_baggage_impl = require_chunk.__esmMin((() => {
...
var init_symbol = require_chunk.__esmMin((() => {
...
var diag$1;
var init_utils$1 = require_chunk.__esmMin((() => {
	init_diag();
	init_baggage_impl();
	init_symbol();
...
var init_context$1 = require_chunk.__esmMin((() => {
...
var init_consoleLogger = require_chunk.__esmMin((() => {
	consoleMap = [
		{
			n: "error",
			c: "error"
...
var init_NoopMeter = require_chunk.__esmMin((() => {
	__extends = (function() {
...
var ValueType;
var init_Metric = require_chunk.__esmMin((() => {
	(function(ValueType) {
...
var init_TextMapPropagator = require_chunk.__esmMin((() => {
...
var init_NoopContextManager = require_chunk.__esmMin((() => {
	init_context$1();
...
var init_context = require_chunk.__esmMin((() => {
...
var TraceFlags;
var init_trace_flags = require_chunk.__esmMin((() => {
	(function(TraceFlags) {
...
var init_invalid_span_constants = require_chunk.__esmMin((() => {
	init_trace_flags();
...
var init_NonRecordingSpan = require_chunk.__esmMin((() => {
...
var SPAN_KEY;
var init_context_utils = require_chunk.__esmMin((() => {
	init_context$1();
...
var init_spancontext_utils = require_chunk.__esmMin((() => {
	init_invalid_span_constants();
	init_NonRecordingSpan();
...
var init_NoopTracer = require_chunk.__esmMin((() => {
	init_context();
	init_context_utils();
	init_NonRecordingSpan();
...
var init_ProxyTracer = require_chunk.__esmMin((() => {
	init_NoopTracer();
...
var init_NoopTracerProvider = require_chunk.__esmMin((() => {
	init_NoopTracer();
...
var init_ProxyTracerProvider = require_chunk.__esmMin((() => {
	init_ProxyTracer();
...
var init_SamplingResult = require_chunk.__esmMin((() => {
...
var SpanKind;
var init_span_kind = require_chunk.__esmMin((() => {
	(function(SpanKind) {
...
var SpanStatusCode;
var init_status = require_chunk.__esmMin((() => {
...
var init_tracestate_validators = require_chunk.__esmMin((() => {
...
var init_tracestate_impl = require_chunk.__esmMin((() => {
...
var context;
var init_context_api = require_chunk.__esmMin((() => {
	init_context();
...
var diag;
var init_diag_api = require_chunk.__esmMin((() => {
	init_diag();
...
var init_NoopMeterProvider = require_chunk.__esmMin((() => {
	init_NoopMeter();
...
var init_metrics = require_chunk.__esmMin((() => {
...
var metrics;
var init_metrics_api = require_chunk.__esmMin((() => {
	init_metrics();
...
var init_NoopTextMapPropagator = require_chunk.__esmMin((() => {
...
var BAGGAGE_KEY;
var init_context_helpers = require_chunk.__esmMin((() => {
	init_context();
	init_context$1();
...
var init_propagation = require_chunk.__esmMin((() => {
	init_global_utils();
...
var propagation;
var init_propagation_api = require_chunk.__esmMin((() => {
	init_propagation();
...
var init_trace = require_chunk.__esmMin((() => {
	init_global_utils();
...
var trace;
var init_trace_api = require_chunk.__esmMin((() => {
	init_trace();
...
var esm_default;
var init_esm = require_chunk.__esmMin((() => {
	init_utils$1();
	init_context$1();
	init_consoleLogger();
	init_types();
...
Object.defineProperty(exports, "esm_exports", {
	enumerable: true,
	get: function() {
		return esm_exports;
	}
});
Object.defineProperty(exports, "init_esm", {
	enumerable: true,
	get: function() {
		return init_esm;
	}
