...
const require_axios$1 = require("./axios.js");
let fs = require("fs");
...
//#region ../../packages/workbuddy-server/src/net/net-log.ts
/**
* Node app-server 网络请求统一日志。
*
* 所有在 app-server Node.js 侧发起的 HTTP 请求（RestOperations / AuthService 独立 axios /
* GalileoExporter 自定义 HTTPClient）都走这里打日志，方便一眼看出每个请求是否走了代理。
*
* 固定格式：
*   [NetLog] METHOD URL -> proxy=host:port | DIRECT (status=NNN, ms=NN, source=XXX)
*   [NetLog] METHOD URL -> proxy=host:port ERROR <code> (ms=NN, source=XXX): <message>
*/
var MAX_URL_LENGTH = 512;
var netMainLog = {
...
/**
* URL 脱敏：将敏感 query key 的值替换为 `<redacted>`，超长截断。
*/
function sanitizeUrlForLog$1(rawUrl) {
	if (!rawUrl) return "";
	let sanitized = rawUrl;
	try {
		const parsed = new URL(rawUrl);
		let changed = false;
		for (const key of Array.from(parsed.searchParams.keys())) if (SENSITIVE_QUERY_KEYS.has(key.toLowerCase())) {
			parsed.searchParams.set(key, "<redacted>");
			changed = true;
		}
		if (changed) sanitized = parsed.toString();
	} catch {}
	if (sanitized.length > MAX_URL_LENGTH) sanitized = `${sanitized.slice(0, MAX_URL_LENGTH)}...<truncated>`;
	return sanitized;
}
...
/**
* 写一条统一的 `[NetLog]` 日志。成功 info，失败 warn。
*
* 不抛异常 —— 日志失败不应影响业务路径。
*/
function logNetRequest(entry) {
	try {
		const method = (entry.method || "GET").toUpperCase();
		const url = sanitizeUrlForLog$1(entry.url);
		const source = entry.source ? `source=${entry.source}` : void 0;
		const ms = entry.durationMs !== void 0 ? `ms=${entry.durationMs}` : void 0;
		if (entry.error) {
			const parts = [ms, source].filter(Boolean).join(", ");
			netMainLog.warn(`[NetLog] ${method} ${url} -> ${entry.proxy} ERROR ${formatError(entry.error)}` + (parts ? ` (${parts})` : ""));
			return;
		}
		const parts = [
			entry.status !== void 0 ? `status=${entry.status}` : void 0,
			ms,
			source
		].filter(Boolean).join(", ");
		netMainLog.info(`[NetLog] ${method} ${url} -> ${entry.proxy}` + (parts ? ` (${parts})` : ""));
	} catch {}
}
//#endregion
//#region ../../node_modules/.pnpm/undici@6.25.0/node_modules/undici/lib/core/symbols.js
var require_symbols$4 = /* @__PURE__ */ require_chunk.__commonJSMin(((exports, module) => {
	module.exports = {
		kClose: Symbol("close"),
...
var require_errors = /* @__PURE__ */ require_chunk.__commonJSMin(((exports, module) => {
...
var require_constants$4 = /* @__PURE__ */ require_chunk.__commonJSMin(((exports, module) => {
...
var require_tree = /* @__PURE__ */ require_chunk.__commonJSMin(((exports, module) => {
...
var require_util$7 = /* @__PURE__ */ require_chunk.__commonJSMin(((exports, module) => {
...
var require_diagnostics = /* @__PURE__ */ require_chunk.__commonJSMin(((exports, module) => {
...
var require_request$1 = /* @__PURE__ */ require_chunk.__commonJSMin(((exports, module) => {
...
var require_dispatcher = /* @__PURE__ */ require_chunk.__commonJSMin(((exports, module) => {
...
var require_dispatcher_base = /* @__PURE__ */ require_chunk.__commonJSMin(((exports, module) => {
...
var require_connect = /* @__PURE__ */ require_chunk.__commonJSMin(((exports, module) => {
...
var require_constants$3 = /* @__PURE__ */ require_chunk.__commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
...
var require_llhttp_wasm = /* @__PURE__ */ require_chunk.__commonJSMin(((exports, module) => {
...
var require_llhttp_simd_wasm = /* @__PURE__ */ require_chunk.__commonJSMin(((exports, module) => {
...
var require_constants$2 = /* @__PURE__ */ require_chunk.__commonJSMin(((exports, module) => {
...
var require_global$1 = /* @__PURE__ */ require_chunk.__commonJSMin(((exports, module) => {
...
var require_data_url = /* @__PURE__ */ require_chunk.__commonJSMin(((exports, module) => {
...
var require_webidl = /* @__PURE__ */ require_chunk.__commonJSMin(((exports, module) => {
...
var require_util$6 = /* @__PURE__ */ require_chunk.__commonJSMin(((exports, module) => {
...
var require_symbols$3 = /* @__PURE__ */ require_chunk.__commonJSMin(((exports, module) => {
	module.exports = {
		kUrl: Symbol("url"),
...
var require_formdata = /* @__PURE__ */ require_chunk.__commonJSMin(((exports, module) => {
...
var require_formdata_parser = /* @__PURE__ */ require_chunk.__commonJSMin(((exports, module) => {
...
var require_body = /* @__PURE__ */ require_chunk.__commonJSMin(((exports, module) => {
	var util = require_util$7();
...
var require_client_h1 = /* @__PURE__ */ require_chunk.__commonJSMin(((exports, module) => {
...
var require_client_h2 = /* @__PURE__ */ require_chunk.__commonJSMin(((exports, module) => {
...
var require_redirect_handler = /* @__PURE__ */ require_chunk.__commonJSMin(((exports, module) => {
	var util = require_util$7();
...
var require_redirect_interceptor = /* @__PURE__ */ require_chunk.__commonJSMin(((exports, module) => {
...
var require_fixed_queue = /* @__PURE__ */ require_chunk.__commonJSMin(((exports, module) => {
	var kSize = 2048;
	var kMask = kSize - 1;
...
var require_pool_stats = /* @__PURE__ */ require_chunk.__commonJSMin(((exports, module) => {
...
var require_pool_base = /* @__PURE__ */ require_chunk.__commonJSMin(((exports, module) => {
	var DispatcherBase = require_dispatcher_base();
...
var require_balanced_pool = /* @__PURE__ */ require_chunk.__commonJSMin(((exports, module) => {
...
var require_agent = /* @__PURE__ */ require_chunk.__commonJSMin(((exports, module) => {
	var { InvalidArgumentError } = require_errors();
...
var require_proxy_agent = /* @__PURE__ */ require_chunk.__commonJSMin(((exports, module) => {
...
var require_env_http_proxy_agent = /* @__PURE__ */ require_chunk.__commonJSMin(((exports, module) => {
	var DispatcherBase = require_dispatcher_base();
...
var require_retry_handler = /* @__PURE__ */ require_chunk.__commonJSMin(((exports, module) => {
...
var require_retry_agent = /* @__PURE__ */ require_chunk.__commonJSMin(((exports, module) => {
	var Dispatcher = require_dispatcher();
...
var require_util$5 = /* @__PURE__ */ require_chunk.__commonJSMin(((exports, module) => {
...
var require_api_request = /* @__PURE__ */ require_chunk.__commonJSMin(((exports, module) => {
...
var require_abort_signal = /* @__PURE__ */ require_chunk.__commonJSMin(((exports, module) => {
...
var require_api_stream = /* @__PURE__ */ require_chunk.__commonJSMin(((exports, module) => {
...
var require_api_pipeline = /* @__PURE__ */ require_chunk.__commonJSMin(((exports, module) => {
...
var require_api_upgrade = /* @__PURE__ */ require_chunk.__commonJSMin(((exports, module) => {
...
var require_api_connect = /* @__PURE__ */ require_chunk.__commonJSMin(((exports, module) => {
...
var require_api = /* @__PURE__ */ require_chunk.__commonJSMin(((exports, module) => {
...
var require_mock_errors = /* @__PURE__ */ require_chunk.__commonJSMin(((exports, module) => {
...
var require_mock_symbols = /* @__PURE__ */ require_chunk.__commonJSMin(((exports, module) => {
	module.exports = {
		kAgent: Symbol("agent"),
...
var require_mock_utils = /* @__PURE__ */ require_chunk.__commonJSMin(((exports, module) => {
...
var require_mock_interceptor = /* @__PURE__ */ require_chunk.__commonJSMin(((exports, module) => {
...
var require_mock_client = /* @__PURE__ */ require_chunk.__commonJSMin(((exports, module) => {
...
var require_mock_pool = /* @__PURE__ */ require_chunk.__commonJSMin(((exports, module) => {
...
var require_pluralizer = /* @__PURE__ */ require_chunk.__commonJSMin(((exports, module) => {
	var singulars = {
		pronoun: "it",
		is: "is",
		was: "was",
...
var require_pending_interceptors_formatter = /* @__PURE__ */ require_chunk.__commonJSMin(((exports, module) => {
...
var require_mock_agent = /* @__PURE__ */ require_chunk.__commonJSMin(((exports, module) => {
...
var require_global = /* @__PURE__ */ require_chunk.__commonJSMin(((exports, module) => {
...
var require_decorator_handler = /* @__PURE__ */ require_chunk.__commonJSMin(((exports, module) => {
...
var require_redirect = /* @__PURE__ */ require_chunk.__commonJSMin(((exports, module) => {
	var RedirectHandler = require_redirect_handler();
	module.exports = (opts) => {
...
var require_dump = /* @__PURE__ */ require_chunk.__commonJSMin(((exports, module) => {
	var util = require_util$7();
	var { InvalidArgumentError, RequestAbortedError } = require_errors();
...
var require_headers = /* @__PURE__ */ require_chunk.__commonJSMin(((exports, module) => {
...
var require_response = /* @__PURE__ */ require_chunk.__commonJSMin(((exports, module) => {
...
var require_dispatcher_weakref = /* @__PURE__ */ require_chunk.__commonJSMin(((exports, module) => {
...
var require_request = /* @__PURE__ */ require_chunk.__commonJSMin(((exports, module) => {
...
var require_fetch = /* @__PURE__ */ require_chunk.__commonJSMin(((exports, module) => {
...
var require_symbols$2 = /* @__PURE__ */ require_chunk.__commonJSMin(((exports, module) => {
	module.exports = {
...
var require_progressevent = /* @__PURE__ */ require_chunk.__commonJSMin(((exports, module) => {
	var { webidl } = require_webidl();
...
var require_encoding = /* @__PURE__ */ require_chunk.__commonJSMin(((exports, module) => {
	/**
...
var require_util$4 = /* @__PURE__ */ require_chunk.__commonJSMin(((exports, module) => {
...
var require_filereader = /* @__PURE__ */ require_chunk.__commonJSMin(((exports, module) => {
...
var require_symbols$1 = /* @__PURE__ */ require_chunk.__commonJSMin(((exports, module) => {
...
var require_util$3 = /* @__PURE__ */ require_chunk.__commonJSMin(((exports, module) => {
...
var require_cache = /* @__PURE__ */ require_chunk.__commonJSMin(((exports, module) => {
...
var require_cachestorage = /* @__PURE__ */ require_chunk.__commonJSMin(((exports, module) => {
	var { kConstruct } = require_symbols$1();
...
var require_util$2 = /* @__PURE__ */ require_chunk.__commonJSMin(((exports, module) => {
	/**
	* @param {string} value
	* @returns {boolean}
	*/
...
var require_cookies = /* @__PURE__ */ require_chunk.__commonJSMin(((exports, module) => {
...
var require_events = /* @__PURE__ */ require_chunk.__commonJSMin(((exports, module) => {
	var { webidl } = require_webidl();
	var { kEnumerableProperty } = require_util$7();
	var { kConstruct } = require_symbols$4();
...
var require_frame = /* @__PURE__ */ require_chunk.__commonJSMin(((exports, module) => {
...
var require_util = /* @__PURE__ */ require_chunk.__commonJSMin(((exports, module) => {
	/**
...
var require_eventsource_stream = /* @__PURE__ */ require_chunk.__commonJSMin(((exports, module) => {
...
var require_eventsource = /* @__PURE__ */ require_chunk.__commonJSMin(((exports, module) => {
...
var require_undici = /* @__PURE__ */ require_chunk.__commonJSMin(((exports, module) => {
	var Client = require_client();
	var Dispatcher = require_dispatcher();
	var Pool = require_pool();
...
//#endregion
//#region ../../packages/workbuddy-server/src/net/pac-aware-dispatcher.ts
var currentResolver;
var resolverGeneration = 0;
var pacLog = {
	info: (...args) => console.info(...args),
	warn: (...args) => console.warn(...args)
};
/**
* 注入 PAC resolver。daemon 启动期调用一次：
* ```ts
* setPacResolver(url => desktopHost.network.resolveProxy(url));
* ```
* 重复调用会替换；每次替换会推进 generation，让所有 cached dispatcher 重建。
*/
function setPacResolver(resolver) {
	currentResolver = resolver;
	resolverGeneration += 1;
	pacAwareCache.clear();
	pacLog.info(`[PacAware] resolver installed (generation=${resolverGeneration})`);
}
function hasPacResolver() {
	return currentResolver !== void 0;
}
var CACHE_TTL_MS = 6e4;
var CACHE_MAX_ENTRIES = 256;
var PacAwareCache = class {
	constructor() {
	...
	get(key) {
		...
		if (!entry) return;
		if (entry.generation !== resolverGeneration || Date.now() >= entry.expiresAt) {
...
var pacAwareCache = new PacAwareCache();
/**
* 解析 Electron / Chromium 风格的 PAC 规则字符串。
*
* 形如 `"PROXY 10.0.0.1:8080;DIRECT"`，分号分隔 fallback 链。
* 当前实现取**第一个可识别**的规则；后续如需支持失败重试链可扩展返回数组。
*
* 不支持的协议（SOCKS / SOCKS5）当前回退直连，待 5.3.x 解禁。
*/
function parsePacRules(rawRule) {
	...
	for (const segment of trimmed.split(";")) {
		...
		if (!piece) continue;
		if (piece.toUpperCase() === "DIRECT") return {
			proxyUrl: void 0,
			rawRule: trimmed
		};
		const [typeRaw, valueRaw] = piece.split(/\s+/, 2);
		if (!valueRaw) continue;
		const value = valueRaw.trim();
		const type = typeRaw.toUpperCase();
		if (type === "PROXY" || type === "HTTP") {
			const url = normalizeProxyUrl(value, "http");
			if (url) return {
				proxyUrl: url,
				rawRule: trimmed
			};
		} else if (type === "HTTPS") {
			const url = normalizeProxyUrl(value, "https");
			if (url) return {
				proxyUrl: url,
				rawRule: trimmed
			};
...
function normalizeProxyUrl(value, defaultScheme) {
...
/**
* 解析目标 URL 应使用的代理。优先级：
*   1. PAC resolver（per-request，由 daemon 注入）
*   2. env-var fallback（resolveProxyUrl + shouldBypassProxy）
*   3. 直连
*
* 全程异常安全；resolver 抛错 → warn 并 fallback 到 env，不影响请求。
*/
async function resolveProxyForUrl(targetUrl) {
	const key = cacheKey(targetUrl);
	const cached = pacAwareCache.get(key);
	if (cached) return cached;
	let resolved;
	if (currentResolver) try {
		resolved = parsePacRules(await currentResolver(targetUrl));
		pacLog.info(`[PacAware] resolve url=${sanitizeUrlForLog(targetUrl)} rule="${resolved.rawRule}" → ${resolved.proxyUrl ? `proxy=${sanitizeProxyForLog(resolved.proxyUrl)}` : "DIRECT"}`);
	} catch (err) {
		pacLog.warn(`[PacAware] resolver threw, falling back to env: ${String(err)}`);
		resolved = void 0;
	}
	if (!resolved) {
		const envProxy = resolveProxyUrl();
		if (envProxy && !shouldBypassProxy(targetUrl)) resolved = {
			proxyUrl: envProxy,
			rawRule: `[env-fallback] ${sanitizeProxyForLog(envProxy)}`
		};
		else resolved = {
			proxyUrl: void 0,
			rawRule: envProxy ? "[env-bypass]" : "[env-direct]"
		};
	}
	pacAwareCache.set(key, resolved);
	return resolved;
}
function sanitizeUrlForLog(targetUrl) {
	try {
		const u = new URL(targetUrl);
...
var dispatcherBundle;
var proxyDispatcherByUrl = /* @__PURE__ */ new Map();
function getOrCreateProxyDispatcher(proxyUrl, tlsOpts) {
	const cached = proxyDispatcherByUrl.get(proxyUrl);
	if (cached) return cached;
	const dispatcher = new (require_undici()).ProxyAgent({
		uri: proxyUrl,
		...tlsOpts ? {
			connect: tlsOpts,
			requestTls: tlsOpts
...
function getOrCreateDirectDispatcher(tlsOpts) {
	if (dispatcherBundle?.direct) return dispatcherBundle.direct;
	const direct = new (require_undici()).Agent(tlsOpts ? { connect: tlsOpts } : {});
	dispatcherBundle = {
		...dispatcherBundle || {},
		direct
	};
...
/**
* 重置 dispatcher 缓存。代理切换 / TLS 信任根变化时调用。
*/
function resetPacAwareDispatcherCache() {
	dispatcherBundle = void 0;
	proxyDispatcherByUrl.clear();
	pacAwareCache.clear();
	pacLog.info("[PacAware] dispatcher cache reset");
}
/**
* 创建 PAC-aware 的 undici Dispatcher。
*
* 实现思路：继承 undici.Dispatcher，在 `dispatch` 时按目标 URL 调 resolver，
* 选好 upstream dispatcher 后透传所有事件。这与 undici 官方的
* `EnvHttpProxyAgent` 设计思路一致（看它源码 lib/dispatcher/env-http-proxy-agent.js）。
*/
function createPacAwareDispatcher(tlsOpts) {
	const BaseDispatcher = require_undici().Dispatcher;
	class PacAwareDispatcher extends BaseDispatcher {
		dispatch(opts, handler) {
			const origin = typeof opts.origin === "string" ? opts.origin : String(opts.origin ?? "");
			const targetUrl = origin ? `${origin}${opts.path || ""}` : "";
			const cached = pacAwareCache.get(cacheKey(targetUrl));
			if (cached) return (cached.proxyUrl ? getOrCreateProxyDispatcher(cached.proxyUrl, tlsOpts) : getOrCreateDirectDispatcher(tlsOpts)).dispatch(opts, handler);
			resolveProxyForUrl(targetUrl).then((resolved) => {
				try {
					(resolved.proxyUrl ? getOrCreateProxyDispatcher(resolved.proxyUrl, tlsOpts) : getOrCreateDirectDispatcher(tlsOpts)).dispatch(opts, handler);
				} catch (err) {
					invokeHandlerError(handler, err);
				}
			}, (err) => invokeHandlerError(handler, err));
			return true;
		}
		async close() {
			await Promise.all([dispatcherBundle?.direct?.close?.(), ...Array.from(proxyDispatcherByUrl.values()).map((d) => d.close?.())]);
		}
	}
	return new PacAwareDispatcher();
}
function invokeHandlerError(handler, err) {
	try {
		handler.onError?.(err instanceof Error ? err : new Error(String(err)));
	} catch {}
}
/**
* 将 PAC-aware dispatcher 装到 undici 全局，让所有 `fetch()` 自动 PAC。
*
* 仅当 `hasPacResolver()` 为 true 时才装；否则交回调用方走 env-fallback 路径。
*/
function installPacAwareGlobalDispatcher(tlsOpts) {
	if (!hasPacResolver()) return false;
	try {
		require_undici().setGlobalDispatcher(createPacAwareDispatcher(tlsOpts));
		pacLog.info("[PacAware] installed as undici global dispatcher");
		return true;
	} catch (err) {
		pacLog.warn("[PacAware] failed to install global dispatcher, will fallback to env-based:", err);
		return false;
	}
}
/**
* 给 axios 的 request interceptor 用：返回应挂的 agent。
*
* axios 不支持 undici Dispatcher，所以这里用 http(s)-proxy-agent 包装。
* 走的还是同一个 resolver + cache，行为与 undici 路径一致。
*/
async function getPacAwareAxiosAgentsForUrl(targetUrl, tlsOpts) {
	if (!hasPacResolver()) return {};
	const resolved = await resolveProxyForUrl(targetUrl);
	if (!resolved.proxyUrl) return {};
	let protocol;
	try {
	...
	return buildAxiosAgentsForProxy(resolved.proxyUrl, protocol, tlsOpts);
}
var axiosAgentByProxy = /* @__PURE__ */ new Map();
function buildAxiosAgentsForProxy(proxyUrl, protocol, tlsOpts) {
	let bundle = axiosAgentByProxy.get(proxyUrl);
	if (!bundle) {
		...
		const httpsAgent = new HttpsProxyAgent(proxyUrl, keepAlive);
		if (tlsOpts?.ca) {
			const origConnect = httpsAgent.connect.bind(httpsAgent);
			httpsAgent.connect = function(req, opts) {
				return origConnect(req, {
					...opts,
					ca: tlsOpts.ca
				});
			};
		...
		bundle = {
			http: new HttpProxyAgent(proxyUrl, keepAlive),
			https: httpsAgent
		};
		axiosAgentByProxy.set(proxyUrl, bundle);
	}
	if (protocol === "http:") return { httpAgent: bundle.http };
	if (protocol === "https:") return { httpsAgent: bundle.https };
	return {};
}
//#endregion
//#region ../../packages/workbuddy-server/src/net/system-ca-fallback.ts
/**
* macOS 系统 CA 证书 fallback 读取。
*
* ## 背景
*
* macOS 26.x Apple Silicon 上 Node.js 原生 `tls.getCACertificates('system')` 触发
* `node::crypto::ReadMacOSKeychainCertificates` 中的 SIGSEGV（#62883），且 try/catch
* 兜不住（信号级崩溃）。当 `WORKBUDDY_DISABLE_SYSTEM_CA=1` 时该 API 被完全跳过。
*
* 但用户在系统钥匙串中安装了 MITM 代理（Charles/Fiddler）的根 CA 证书后，
* WorkBuddy 的 HTTPS 请求因缺少对该 CA 的信任而失败。
*
* ## 方案
*
* 用 macOS `security` 命令行工具（不触发原生 SIGSEGV）从系统钥匙串导出受信任的
* CA 证书（PEM 格式），作为 `tls.getCACertificates('system')` 的安全替代。
*
* 此方案只覆盖 macOS；Windows/Linux 不受 #62883 影响，直接用原生 API。
*
* ## 性能
*
* `security find-certificate` 命令在本地执行约 200-500ms，结果缓存在进程内存中
* （证书变更需重启生效，与原生 API 行为一致）。仅在首次调用时执行。
*/
var CERT_REGEX = /-----BEGIN CERTIFICATE-----[\s\S]*?-----END CERTIFICATE-----/g;
/** 缓存已读取的系统 CA，进程生命周期内不变（与原生 API 行为一致）。 */
var cachedSystemCAs;
/**
* 通过 macOS `security` CLI 读取系统钥匙串中的受信任 CA 证书。
*
* 读取范围：
* - `~/Library/Keychains/login.keychain-db` — 用户钥匙串（Whistle/Charles 等工具的 CA 通常在这里）
* - `/Library/Keychains/System.keychain` — 系统级证书（管理员安装的 CA）
* - `/System/Library/Keychains/SystemRootCertificates.keychain` — Apple 预置根证书
*
* @returns PEM 格式证书数组，读取失败返回空数组（不阻塞启动）
*/
function readSystemCAsViaCli() {
	if (cachedSystemCAs !== void 0) return cachedSystemCAs;
	...
	const keychains = [
		require("path").join(os$2.homedir(), "Library", "Keychains", "login.keychain-db"),
		"/Library/Keychains/System.keychain",
		"/System/Library/Keychains/SystemRootCertificates.keychain"
	];
	for (const keychain of keychains) try {
		const matches = (0, child_process.execFileSync)("security", [
			"find-certificate",
			"-a",
			"-p",
			keychain
	...
	cachedSystemCAs = [...new Set(certs)];
	return cachedSystemCAs;
}
//#endregion
//#region ../../packages/workbuddy-server/src/net/proxy-agents.ts
/**
* Node app-server proxy agent helpers.
*
* app-server 当前会在 desktop 进程内运行，但这里的职责是纯 Node 网络栈：
*   - Chromium / renderer fetch — 由 desktop bootstrap 中的
*     `app.commandLine.appendSwitch('proxy-server', ...)` 处理。
*   - Node.js（axios / https.request / undici fetch / ws）— **默认不读** HTTP_PROXY，
*     需要显式挂 agent 或设置 undici dispatcher。
*
* 本模块是 app-server Node.js 侧唯一的"代理决策源"，集中完成：
*   1. 解析环境变量 HTTP_PROXY / HTTPS_PROXY
*   2. 判断 URL 是否应 bypass（loopback + NO_PROXY）
*   3. 缓存并返回可挂到 axios config 的 HttpProxyAgent / HttpsProxyAgent
*   4. 通过 undici.setGlobalDispatcher 让全局 fetch() 走代理
*
* 不覆盖 http.globalAgent / https.globalAgent —— 历史上那样做会与部分抓包工具
* (Whistle) + 老版 https-proxy-agent 组合产生 CONNECT 握手异常，参见 Issue #34939。
*
* CLI 侧 packages/agent-cli/src/node/http/http-proxy-interceptor.ts 已经在 sidecar
* 上工作；app-server 独立的 CellJS 容器里没有它，所以这里是补齐的版本。
*/
...
/** 与 CLI 侧 HttpProxyInterceptor 对齐的 keep-alive 配置 */
var KEEP_ALIVE_OPTS = {
	keepAlive: true,
	keepAliveMsecs: 2e3
};
var agentCache;
var undiciDispatcherInstalled = false;
/**
* 读取并规范化环境变量里的代理地址。
*
* 优先顺序：HTTPS_PROXY > https_proxy > HTTP_PROXY > http_proxy
* 返回带 scheme 的完整 URL（例如 `http://10.0.0.13:8888/`），没有时返回 undefined。
*/
...
/**
* 把代理 URL 脱敏后转成 `host:port` 供日志展示（不含 user:pass）。
*/
...
*
* 匹配规则：
*   - loopback 主机名（localhost / 127.0.0.1 / ::1）恒绕过
*   - `NO_PROXY` 每一项按 CSV 拆分后做：完全相等 / 子域后缀匹配（`.example.com` 或 `example.com`）
*     / 通配 `*`
*/
...
/**
* 日志级友好展示：本次请求用了哪个代理，还是直连。
*/
function describeProxyForLog(targetUrl) {
	const proxy = resolveProxyUrl();
	if (!proxy || shouldBypassProxy(targetUrl)) return "DIRECT";
...
function getAgentBundle(proxyUrl) {
	...
	const { HttpProxyAgent } = require_dist$2.require_dist$1();
	const { HttpsProxyAgent } = require_dist$2.require_dist();
	const trustedCAs = resolveTrustedCAs();
	const httpsAgent = new HttpsProxyAgent(proxyUrl, KEEP_ALIVE_OPTS);
	if (trustedCAs) {
		const origConnect = httpsAgent.connect.bind(httpsAgent);
		httpsAgent.connect = function(req, opts) {
			return origConnect(req, {
	...
	proxyAgentLog.info(`[NetProxy] getAgentBundle: created agents proxy=${sanitizeProxyForLog(proxyUrl)} caInjected=${!!trustedCAs} caCount=${trustedCAs?.length ?? 0} injectMode=connect-wrap`);
	return bundle;
}
/**
* 按目标 URL 返回可挂到 axios config 上的 agent。
*
* - 无代理 / bypass：返回空对象（调用方不覆盖 axios 默认行为）
* - http 协议：只挂 httpAgent
* - https 协议：只挂 httpsAgent
*/
function getAxiosAgentsForUrl(targetUrl) {
	const proxy = resolveProxyUrl();
	if (!proxy || shouldBypassProxy(targetUrl)) {
		proxyAgentLog.info(`[NetProxy] getAxiosAgentsForUrl: NO_AGENT url=${targetUrl} reason=${proxy ? "bypass" : "no-proxy"}`);
		return {};
	}
	let protocol;
	try {
	...
	const bundle = getAgentBundle(proxy);
	if (protocol === "http:") {
		proxyAgentLog.info(`[NetProxy] getAxiosAgentsForUrl: HTTP_AGENT url=${targetUrl}`);
		return { httpAgent: bundle.http };
	}
	if (protocol === "https:") {
		proxyAgentLog.info(`[NetProxy] getAxiosAgentsForUrl: HTTPS_AGENT url=${targetUrl}`);
		return { httpsAgent: bundle.https };
	}
	return {};
}
/**
* 按目标 URL 返回对应协议的 Node agent，供裸用 `http.request` / `https.get` 的场景。
*
* 返回 undefined 表示不用挂（无代理或 bypass）。与 `getAxiosAgentsForUrl` 共享同一
* agent 缓存。
*/
function getNodeAgentForUrl(targetUrl) {
	const { httpAgent, httpsAgent } = getAxiosAgentsForUrl(targetUrl);
	return httpsAgent ?? httpAgent;
}
/**
* 汇集 TLS 信任根：Node 内置 Mozilla 根 + 系统钥匙串 + `NODE_EXTRA_CA_CERTS`，
* 主要为 Whistle/Charles 等 MITM 抓包代理的自签根兜底。
*/
function resolveTrustedCAs() {
	const cas = /* @__PURE__ */ new Set();
	for (const cert of tls.rootCertificates) cas.add(cert);
	const bundledCount = cas.size;
	const getCACertificates = tls.getCACertificates;
	const disableSystemCA = process.env.WORKBUDDY_DISABLE_SYSTEM_CA === "1";
	let systemCount = 0;
	let extraCount = 0;
	let systemSkipped = false;
	let systemViaCliFallback = false;
	...
	if (typeof getCACertificates === "function") {
		if (disableSystemCA) {
			...
			if (process.platform === "darwin" && hasProxy) try {
				const cliCerts = readSystemCAsViaCli();
				systemCount = cliCerts.length;
				systemViaCliFallback = true;
				for (const cert of cliCerts) {
					cas.add(cert);
					if (systemSubjects.length < 20) try {
						const x = new crypto.X509Certificate(cert);
						systemSubjects.push(x.subject.replace(/\n/g, " | ").slice(0, 120));
					} catch {
						systemSubjects.push("<parse-failed>");
					}
				}
			} catch (err) {
				proxyAgentLog.warn("[NetProxy] readSystemCAsViaCli() failed:", err);
				systemSkipped = true;
			}
			else systemSkipped = true;
		} else try {
			...
			proxyAgentLog.warn("[NetProxy] tls.getCACertificates(\"system\") failed:", err);
		}
		try {
			const list = getCACertificates("extra");
			extraCount = list.length;
			for (const cert of list) cas.add(cert);
		} catch (err) {
			proxyAgentLog.warn("[NetProxy] tls.getCACertificates(\"extra\") failed:", err);
		}
	}
	proxyAgentLog.info(`[NetProxy] resolveTrustedCAs: bundled=${bundledCount} system=${systemCount}${systemSkipped ? "(skipped)" : systemViaCliFallback ? "(cli-fallback)" : ""} extra=${extraCount} merged=${cas.size} getCACertAvailable=${typeof getCACertificates === "function"} disableSystemCA=${disableSystemCA}`);
	if (systemSubjects.length > 0) proxyAgentLog.info(`[NetProxy] resolveTrustedCAs system subjects: ${JSON.stringify(systemSubjects)}`);
	return cas.size > 0 ? Array.from(cas) : void 0;
}
/**
* 通过 undici.setGlobalDispatcher 让 app-server 全局 `fetch()` 走代理。
*
* 优先使用 undici 内置的 EnvHttpProxyAgent —— 它原生读取 HTTP_PROXY / HTTPS_PROXY / NO_PROXY，
* 对 NO_PROXY 命中的目标走直连。
* 退回方案：显式 ProxyAgent(url)（版本太老缺 EnvHttpProxyAgent 时使用）。
*
* **回环兜底（关键）**：用户的系统代理 bypass 列表（Windows 设置 / macOS 网络偏好）和
* Node.js `NO_PROXY` 环境变量是**两套独立配置**。我们见过用户在系统 bypass 里配了
* `127.0.0.1`，但 `NO_PROXY` 环境变量为空 → undici EnvHttpProxyAgent 把对本机 ACP
* 端点 (`http://127.0.0.1:xxxxx/api/v1/acp`) 的 fetch 也送给上游代理，代理对回环地址
* 的 CONNECT 隧道返回 403，导致 CodeBuddyCodeBackend.connectClient 反复失败、所有
* 会话都创建不出来（参见线上日志）。
*
* 因此这里：
*   1. 用 `mergeNoProxy()` 把 `localhost,127.0.0.1,::1` 合并进当前 NO_PROXY，**显式**
*      传给 EnvHttpProxyAgent，不依赖用户环境是否配齐
*   2. 顺便把同样的值写回 `process.env.NO_PROXY`，让其他读 env 的库（axios 第三方
*      插件、未来新增的 fetch 调用方）也能受益
*
* **TLS**：undici 默认只信 Node 内置根，MITM 代理（Whistle/Charles）会握手失败。
* 通过 `requestTls.ca`（代理隧道目标 TLS）和 `connect.ca`（直连）注入系统 CA。
*
* **幂等性**（#49077 修订）：
*   - 首次调用：按 env 安装 EnvHttpProxyAgent / 直连 Agent，并把 `undiciDispatcherInstalled` 置 true
*   - 重复调用：直接跳过（依赖 `invalidateProxyAgentCache` 重置标记后才会重装）
*
*   不再"代理 env 缺失时直接 SKIP"——这样会导致从有代理切到 mode=none 后，
*   旧的 EnvHttpProxyAgent 仍然挂在 globalDispatcher 上让 fetch 继续走老代理。
*   现在 env 缺失时会显式装一个直连 Agent，把旧 dispatcher 替换掉。
*/
function installUndiciProxyDispatcher() {
	proxyAgentLog.info(`[NetProxy] installUndiciProxyDispatcher: ENTER (already=${undiciDispatcherInstalled} node=${process.version} HTTPS_PROXY=${process.env.HTTPS_PROXY ? "set" : "unset"} HTTP_PROXY=${process.env.HTTP_PROXY ? "set" : "unset"} pacResolver=${hasPacResolver() ? "present" : "absent"})`);
	if (undiciDispatcherInstalled) return;
	if (hasPacResolver()) {
		const trustedCAs = resolveTrustedCAs();
		if (installPacAwareGlobalDispatcher(trustedCAs ? { ca: trustedCAs } : void 0)) {
			undiciDispatcherInstalled = true;
			proxyAgentLog.info("[NetProxy] undici global dispatcher: PacAware (per-request resolveProxy)");
			return;
		}
	}
	...
	if (!proxyUrl) {
		try {
			...
			undiciDispatcherInstalled = true;
			proxyAgentLog.info("[NetProxy] installUndiciProxyDispatcher: no proxy resolved, installed direct Agent");
		} catch (err) {
			proxyAgentLog.warn("[NetProxy] installUndiciProxyDispatcher: failed to install direct Agent:", err);
		}
		return;
	}
	const mergedNoProxy = require_proxy_env.mergeNoProxy(process.env.NO_PROXY || process.env.no_proxy);
	process.env.NO_PROXY = mergedNoProxy;
	const trustedCAs = resolveTrustedCAs();
	const tlsOpts = trustedCAs ? { ca: trustedCAs } : void 0;
	const caSummary = trustedCAs ? `system+extra+bundled CA count=${trustedCAs.length}` : "bundled CA only (tls.getCACertificates unavailable)";
	try {
		const undici = require_undici();
		const { setGlobalDispatcher } = undici;
		const EnvHttpProxyAgentCtor = undici.EnvHttpProxyAgent;
		if (EnvHttpProxyAgentCtor) {
			setGlobalDispatcher(new EnvHttpProxyAgentCtor({
			...
			undiciDispatcherInstalled = true;
			proxyAgentLog.info(`[NetProxy] undici global dispatcher: EnvHttpProxyAgent (proxy=${sanitizeProxyForLog(proxyUrl)}, noProxy=${mergedNoProxy}, ${caSummary})`);
			return;
		}
		...
		undiciDispatcherInstalled = true;
		proxyAgentLog.warn(`[NetProxy] undici global dispatcher: ProxyAgent fallback (proxy=${sanitizeProxyForLog(proxyUrl)}, ${caSummary}); NO_PROXY bypass NOT enforced — upgrade undici to enable EnvHttpProxyAgent`);
	} catch (err) {
		proxyAgentLog.warn("[NetProxy] failed to install undici global dispatcher:", err);
	}
}
/**
* 给全局 `axios`（裸 import axios）打上代理拦截器。
*
* app-server 里有若干模块（moderation-service、queue、connect-cloud-service-tool 等）
* 直接用裸 `axios.get/post` 而非 `axios.create()` 实例，无法在创建时注入配置。
* 在这里统一处理，逻辑与 AuthService 独立实例的拦截器保持一致：
*   1. `proxy: false` — 禁用 axios 内置代理解析（防严格代理 400 Bad Request）
*   2. 按目标 URL 通过 `getAxiosAgentsForUrl` 挂 httpsAgent/httpAgent
*
* **为什么安全地挂在全局 axios 上**：
*   - app-server 不加载任何会全局 import axios 的第三方库；
*   - 即便第三方库有 axios 请求，走代理通常也是期望行为；
*   - 万一某个请求不期望走代理，调用方可在 `config` 里覆盖 `proxy` / `httpsAgent`；
*   - `cli-pulse-client.ts` 打 `127.0.0.1`，命中 LOOPBACK bypass，不会被代理。
*
* 幂等：重复调用只注册一次拦截器。必须在任何 axios 请求之前执行（Phase 1）。
*/
var axiosGlobalInterceptorInstalled = false;
function installAxiosGlobalProxy() {
	if (axiosGlobalInterceptorInstalled) return;
	const axios = require_axios$1.require_axios();
	axios.interceptors.request.use(async (config) => {
		...
		try {
			...
			let targetUrl;
			if (/^https?:\/\//i.test(url)) targetUrl = url;
			else {
				const left = base.endsWith("/") ? base.slice(0, -1) : base;
				const right = url.startsWith("/") ? url : `/${url}`;
				targetUrl = left ? `${left}${right}` : url;
			}
			if (targetUrl) {
				let httpAgent;
				let httpsAgent;
				if (hasPacResolver()) {
					const trustedCAs = resolveTrustedCAs();
					const agents = await getPacAwareAxiosAgentsForUrl(targetUrl, trustedCAs ? { ca: trustedCAs } : void 0);
					httpAgent = agents.httpAgent;
					httpsAgent = agents.httpsAgent;
				}
				if (!httpAgent && !httpsAgent) {
					const fallback = getAxiosAgentsForUrl(targetUrl);
					httpAgent = fallback.httpAgent;
					httpsAgent = fallback.httpsAgent;
				}
	...
	axios.interceptors.response.use(void 0, (error) => {
		const config = error?.config;
		if (!config || config.__proxyRetried) return Promise.reject(error);
		const code = error?.code;
		if (!code) return Promise.reject(error);
		if (!(code === "ECONNREFUSED" || code === "ECONNRESET" || code === "ETIMEDOUT" || code === "UNABLE_TO_VERIFY_LEAF_SIGNATURE" || code === "DEPTH_ZERO_SELF_SIGNED_CERT" || code === "SELF_SIGNED_CERT_IN_CHAIN")) return Promise.reject(error);
		if (!(process.env.WORKBUDDY_PROXY_SOURCE === "system")) return Promise.reject(error);
		proxyAgentLog.info(`[NetProxy] proxy error in main process (code=${code}), clearing cache and retrying direct`);
		delete process.env.HTTP_PROXY;
		delete process.env.HTTPS_PROXY;
		delete process.env.http_proxy;
		delete process.env.https_proxy;
		invalidateProxyAgentCache();
		config.__proxyRetried = true;
		delete config.httpAgent;
		delete config.httpsAgent;
		return axios.request(config);
	});
	axiosGlobalInterceptorInstalled = true;
	proxyAgentLog.info("[NetProxy] installAxiosGlobalProxy: global axios interceptor installed (request + response)");
}
/**
* 清除已缓存的代理 Agent 实例，并按当前 env 重新安装 undici 全局 dispatcher。
*
* 调用时机：`applyProxySettingsToMain` 在改完 process.env 之后调用一次，让 Main 进程
* 内所有未来发出的请求（axios + fetch）都按新代理走。
*
* 三件事：
*   1. 清空 axios httpAgent/httpsAgent 缓存（下次 `getAgentBundle` 用新 env 重建）
*   2. 重置 `undiciDispatcherInstalled` 标记
*   3. 立刻调用 `installUndiciProxyDispatcher` 按当前 env 重装全局 dispatcher
*
* 为什么必须重装 undici dispatcher（#49077 修订）：
*   `EnvHttpProxyAgent` 的构造参数里有 `noProxy / connect.ca / requestTls.ca` 等
*   **构造时固化**的字段；同时它对 `HTTP_PROXY` env 的读取行为是 "构造时已无代理→
*   后续直连；构造时有代理→后续按该代理走"，并不会因为 `delete process.env.HTTP_PROXY`
*   就自动切回直连。所以仅清 axios 缓存而保留旧 dispatcher，会导致 Main 进程里
*   所有走 `fetch()` 的轮询请求（Activity/License/EnterprisePolicy 等）继续打老代理，
*   表现为"在设置里切到直连后，Whistle 仍能抓到 WorkBuddy 的请求"。
*
*   `undici.setGlobalDispatcher()` 本身允许重复调用——前一个 dispatcher 会被替换；
*   `installUndiciProxyDispatcher` 现在在无代理场景下也会显式装一个直连 Agent，
*   覆盖掉之前装的 EnvHttpProxyAgent。
*/
function invalidateProxyAgentCache() {
	if (agentCache) agentCache.clear();
	resetPacAwareDispatcherCache();
	try {
		...
		const bundlePath = path.default.join(configDir, "system-ca-bundle.pem");
		fs.default.unlinkSync(bundlePath);
	} catch {}
	undiciDispatcherInstalled = false;
	try {
		installUndiciProxyDispatcher();
	} catch (err) {
		proxyAgentLog.warn("[NetProxy] invalidateProxyAgentCache: reinstall undici dispatcher failed:", err);
	}
	proxyAgentLog.info("[NetProxy] invalidateProxyAgentCache: agent cache cleared + undici dispatcher reinstalled");
}
//#endregion
Object.defineProperty(exports, "describeProxyForLog", {
	enumerable: true,
	get: function() {
		return describeProxyForLog;
	}
});
Object.defineProperty(exports, "getAxiosAgentsForUrl", {
	enumerable: true,
	get: function() {
		return getAxiosAgentsForUrl;
	}
});
Object.defineProperty(exports, "getNodeAgentForUrl", {
	enumerable: true,
	get: function() {
		return getNodeAgentForUrl;
	}
});
Object.defineProperty(exports, "getPacAwareAxiosAgentsForUrl", {
	enumerable: true,
	get: function() {
		return getPacAwareAxiosAgentsForUrl;
	}
});
Object.defineProperty(exports, "hasPacResolver", {
	enumerable: true,
	get: function() {
		return hasPacResolver;
	}
});
Object.defineProperty(exports, "installAxiosGlobalProxy", {
	enumerable: true,
	get: function() {
		return installAxiosGlobalProxy;
	}
});
Object.defineProperty(exports, "installUndiciProxyDispatcher", {
	enumerable: true,
	get: function() {
		return installUndiciProxyDispatcher;
	}
});
Object.defineProperty(exports, "invalidateProxyAgentCache", {
	enumerable: true,
	get: function() {
		return invalidateProxyAgentCache;
	}
});
Object.defineProperty(exports, "logNetRequest", {
	enumerable: true,
	get: function() {
		return logNetRequest;
	}
});
Object.defineProperty(exports, "readSystemCAsViaCli", {
	enumerable: true,
	get: function() {
		return readSystemCAsViaCli;
	}
});
Object.defineProperty(exports, "require_undici", {
	enumerable: true,
	get: function() {
		return require_undici;
	}
});
Object.defineProperty(exports, "resolveProxyForUrl", {
	enumerable: true,
	get: function() {
		return resolveProxyForUrl;
	}
});
Object.defineProperty(exports, "resolveTrustedCAs", {
	enumerable: true,
	get: function() {
		return resolveTrustedCAs;
	}
});
Object.defineProperty(exports, "sanitizeUrlForLog", {
	enumerable: true,
	get: function() {
		return sanitizeUrlForLog$1;
	}
});
Object.defineProperty(exports, "setPacResolver", {
	enumerable: true,
	get: function() {
		return setPacResolver;
	}
});
