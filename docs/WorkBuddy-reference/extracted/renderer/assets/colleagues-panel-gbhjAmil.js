...
import { $A as reportCreateCancelClick, At as ListType, BA as reportAssistantCreateEntryClick, BB as ChatBubbleIcon, Bk as UserPlusIcon, CP as init_avatar_url, Dg as init_expert, Dt as isFileViewModelCheckable, EP as EXPERT_MARKETPLACE_BASE_URL, Et as init_constants, FB as ChevronRightIcon, Fy as init_colleague_navigation_bus, GA as reportAssistantMoreMenuClick, HO as init_use_floating_layer, IB as ChevronLeftIcon, IL as useAccount, Ig as init_use_share_expert, LA as init_telemetry, L_ as init_use_local_experts, MR as init_src, My as colleagueAgentListChanged$, Nt as init_types, Ny as colleagueConversationPatches$, O_ as init_category_membership, Ph as useModelSelector, Py as colleagueConversationsChanged$, Q_ as useLocale, RB as CheckIcon, Rs as init_contexts, TM as useRouterContextSafe, T_ as init_locale_text, Ty as init_colleague_acp_diag, UA as reportAssistantMoreDeleteClick, UO as useFloatingLayer, U_ as init_use_expert_api, VB as BriefcaseIcon, V_ as init_use_expert_summon, WA as reportAssistantMoreEditClick, XA as reportAssistantTrialClick, ZA as reportAssistantTrialLoadingShow, _T as useQrDataUrl, _k as init_services, _z as TextArea, aE as openPlanUpgrade, aM as init_router, aR as stringifyRendererDiagPayload, aV as Button, aj as reportProfileEditClick, bB as MemoryIcon, bF as isIOAUser, bc as useAgentServices, bf as init_hooks$1, bt as tencentDocsStore, bz as XCloseIcon, cB as RepoConnectIcon, cL as init_useI18n, cj as reportRepositoryAuthResult, dB as PlaneIcon, ej as reportCreateExpertSelectClick, fB as PhoneIcon, fP as init_use_expert_avatar, fv as WorkBuddyTopBar, gT as init_use_qr_data_url, gz as Input, hT as useQQBindSession, iB as SearchIcon, iE as init_plan_upgrade, iR as init_http_logger, ij as reportProfileChatClick, iz as Dropdown, k_ as isExpertInCategory, ky as writeColleagueAcpDiag, lL as useI18n, mI as init_constants$1, mT as init_use_qq_bind_session, nF as init_utils, nj as reportCreateSubmitSuccess, oj as reportProfileTaskClick, pa as normalizeColleagueSessionStatus, pv as init_workbuddy_topbar, rj as reportCreateTemplateMoreClick, sA as MoreDotsIcon, sI as CONNECTOR_NO_AUTH, sj as reportRecommendAssistantChatClick, sz as Modal, tV as AddIcon, tj as reportCreateModelSelectClick, uB as QQIcon, uL as useTranslation, ua as init_session_status, vO as formatRelativeTime, vk as useTencentDocsFacade, wP as resolveAvatarUrl, w_ as getLocalizedText, xB as MailIcon, xL as useLocation, xt as useTencentDocsStore, yO as init_format, yt as init_store, zA as reportAssistantCardProfileClick, zL as useAdapter, zR as message, zk as init_icons } from "./ui-docs-viewer-C2jT2eXi.js";
import { Du as require_react_dom, Ou as require_jsx_runtime, Qo as GitBranch, Qr as ModelSelect, To as Search, ao as init_lucide_react, co as X, ku as require_react, ms as Code, t as init_src$1, vs as CircleX } from "./lib-chat-ui-ChIVprRk.js";
import { _ as init_agent_status, a as shouldBypassBusyGuard, c as applyPatches, d as groupUserConversationsByAgentId, f as init_colleague_conversation_tasks, g as resolveAvatarImageUrl, h as init_colleague_chat_page_helpers, i as init_colleague_chat_guard, l as buildTaskFromUserConversation, m as mergeTaskSources, n as init_colleague_chat_page, p as isPatchAlive, r as BUSY_TIMEOUT_MS, t as ColleagueChatPage, u as buildTasksFromRawAgents, v as mapAgentStatusToVariant, y as init_colleagues_panel$1 } from "./colleague-chat-page-DeUUfHD0.js";
import { t as init_upgrade_banner_character } from "./upgrade-banner-character-CkfROD0n.js";
import { t as init_tencent_docs_panel } from "./tencent-docs-panel-BxZmREXP.js";
import { _ as EmptyState, a as init_use_file_list, b as init_auth_guide, c as init_folder_breadcrumb, i as useFileSearch, l as init_tdoc_columns, m as init_file_list, n as useTdocCheckAuthGate, o as useFileList, p as VirtualList, r as init_use_file_search, s as FolderBreadcrumb, t as init_use_tdoc_check_auth_gate, u as useTDocColumns, v as init_empty_state, y as AuthGuide } from "./use-tdoc-check-auth-gate-B6_s_I1G.js";
import { n as useMarketExperts, t as init_use_market_experts } from "./use-market-experts-BIcib-bI.js";
...
/**
* 助理配额上限弹窗“去升级”统一动作：委托给全局 `openPlanUpgrade`。
*
* 同事面板（`colleagues-panel`）和 `/claw` 创建入口（`use-assistant-quota-gate`）都调用此函数；
* 落地方式（端内购买弹窗 / 海外外跳 / Web 新标签页）由 `utils/plan-upgrade` 统一决策，
* 与账号菜单、Teams 项目/成员配额的「去升级」保持一致。
*/
function openAssistantPlanUpgrade(options) {
	...
	}) !== "embedModal" && options?.onSuccess) refreshWhenPageVisibleAgain(options.onSuccess);
}
/** 注册一次性的「页面重新可见」回调（用完即摘，不累积监听器）。 */
function refreshWhenPageVisibleAgain(refresh) {
...
//#endregion
//#region ../../packages/agent-ui/src/modules/expert/hooks/index.ts
var init_hooks = __esmMin((() => {
	init_use_expert_summon();
	init_use_local_experts();
	init_use_market_experts();
	init_use_share_expert();
			...
			children: [
				...
				actionMenuState && typeof document !== "undefined" && (() => {
					...
					return (0, import_react_dom$2.createPortal)(/* @__PURE__ */ (0, import_jsx_runtime$8.jsx)("div", {
						className: "wb-popover-compact colleagues-chat-float__task-list-item-menu colleagues-chat-float__task-list-item-menu--portal",
						role: "menu",
...
function getSourceFromExpert(expert, type, locale) {
	...
	return {
		id: expert.id,
		marketExpertId: expert.marketExpertId,
...
function filterByCategory(experts, categoryId) {
	...
	return experts.filter((expert) => isExpertInCategory(expert, categoryId));
}
...
function buildExpertPageCategories(categories, allExperts, activeTab) {
	if (activeTab === "team") {
		const baseCategories = categories.filter((category) => allExperts.some((expert) => expert.expertType === "team" && isExpertInCategory(expert, category.id)));
...
var init_hire_expert_modal = __esmMin((() => {
	...
	HireExpertModal = ({ open, selectedSource, onConfirm, onClose }) => {
		...
		const { categories, experts, allExperts, isLoading } = useMarketExperts(null);
		import_react$11.useEffect(() => {
			if (open) {
...
function useMyColleagueConversations(options) {
	...
	const fetchRemoteTasks = (0, import_react$6.useCallback)(async () => {
		...
		return remoteConversations.map((conv) => buildTaskFromUserConversation(agentId, conv));
	}, [
		adapter,
		agentId,
		enabled
	...
	const deleteSession = (0, import_react$6.useCallback)(async (target) => {
		...
		const conversationId = task?.id ?? task?.instanceId ?? targetId;
		if (!conversationId) return {
			ok: false,
			error: "delete target not found"
		};
		if (!adapter.deleteCloudAgentConversation) return {
			ok: false,
			error: "deleteCloudAgentConversation not supported"
		};
		const removePatch = {
			type: "remove-session",
			agentId: task?.agentId,
			instanceId: task?.instanceId ?? conversationId,
			sessionId: task?.sessionId ?? conversationId,
			pendingUntil: Date.now() + PENDING_PATCH_TTL_MS
		};
		try {
			await adapter.deleteCloudAgentConversation({ conversationId });
	...
	SearchableSelect = ({ value, options, onChange, placeholder, searchPlaceholder, emptyText, noMatchText, disabled, loading, loadingText, ariaLabel, optionIcon, resetOption, clearAriaLabel }) => {
		...
		*/
		...
		const popoverNode = open && position ? /* @__PURE__ */ (0, import_jsx_runtime$2.jsxs)("div", {
			ref: popoverRef,
			className: "wb-popover-compact create-colleague-searchable-popover",
			role: "dialog",
			style: {
				position: "fixed",
				...
				showEmpty ? /* @__PURE__ */ (0, import_jsx_runtime$2.jsx)("div", {
					...
					children: filteredOptions.map((option, idx) => {
						...
						return /* @__PURE__ */ (0, import_jsx_runtime$2.jsxs)("li", {
							...
							onMouseLeave: () => {
								setHighlight((current) => current === idx ? NO_HIGHLIGHT_INDEX : current);
							},
							onMouseDown: (event) => {
								event.preventDefault();
								handleSelect(option);
...
var init_tencent_docs_manifest_mcp = __esmMin((() => {
	...
	TENCENT_DOCS_MCP_DOWNLOAD_URL = "https://codebuddy-clawbot-1328944842.cos.ap-beijing.myqcloud.com/attachments/3dcbcc11-a8a8-4fab-8e97-4935734bdc96/1779851082_12945954/user-mcp.json?q-sign-algorithm=sha1&q-ak=REDACTED&q-sign-time=1779851082;1787627082&q-key-time=1779851082;1787627082&q-header-list=host&q-url-param-list=&q-signature=REDACTED";
}));
//#endregion
...
function buildAgentManifestPlugins(expert) {
	...
	const agentName = expert.agentName || pluginName;
	const downloadUrl = `${EXPERT_MARKETPLACE_BASE_URL}/bundles/${pluginName}.tar.gz`;
	return [{
		id: expert.marketExpertId || expert.id,
		name: pluginName,
		marketplace: "experts",
		agentName,
		downloadUrl,
		...expert.version ? { version: expert.version } : {}
	}];
}
...
var init_colleagues_panel = __esmMin((() => {
	...
	CreateColleagueDialog = ({ open, onClose, onCreated, presentation = "modal", editingAgentId, checkQuotaBeforeCreate, onQuotaExceeded }) => {
		...
		*/
		const locale = useLocale();
		const { allExperts } = useMarketExperts(null);
		...
		*/
		...
		const loadInlineRepos = import_react.useCallback(async (provider, force = false) => {
			...
			try {
				...
				console.warn("[ColleagueChat] connectorOauthRepos failed", stringifyRendererDiagPayload({
					provider,
					code,
					error
				}));
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [
											...
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TextArea, {
												...
												status: moderationErrors.description ? "error" : void 0,
	...
	ColleaguesPanel = () => {
		...
		*/
		...
		/** 当前打开 conversation 所属的共享 runtime 根 ID。 */
		const [chatRuntimeId, setChatRuntimeId] = import_react.useState(null);
		...
		*   manifest.plugins[0].name (plugin slug) → useMarketExperts().allExperts → 真实中文名 / i18n
		*/
		const detailLocale = useLocale();
		const { allExperts: detailAllExperts } = useMarketExperts(null);
		...
		*/
		...
		const busyStartedAtRef = import_react.useRef(0);
		import_react.useEffect(() => {
			if (isChatBusy) {
				if (busyStartedAtRef.current === 0) busyStartedAtRef.current = Date.now();
			} else busyStartedAtRef.current = 0;
		}, [isChatBusy]);
		const resolveRecentChatTargetForAgent = import_react.useCallback((agentId, preferred) => {
			if (preferred?.agentId === agentId && preferred.instanceId && preferred.sessionId) return {
				...
				runtimeId: preferred.runtimeId ?? null,
		...
		*/
		const openColleagueChat = import_react.useCallback(async (target, options) => {
			...
			const wantRuntimeId = target.runtimeId ?? null;
			...
			if (isChatOpen && chatColleagueId === target.agentId && !!chatPageRef.current) {
				...
				setChatRuntimeId(wantRuntimeId);
		...
		const consumePendingOpenTarget = import_react.useCallback(() => {
			...
			const { agentId, instanceId, runtimeId, sessionId } = pendingOpenChatTargetRef.current;
		...
		const handleSelectFloatingChatSession = import_react.useCallback((target) => {
			if (isChatBusy) {
				if (!shouldBypassBusyGuard(busyStartedAtRef.current, Date.now(), 1e4)) return;
				writeColleagueAcpDiag("select.busy_timeout_force_proceed", {
					agentId: target.agentId,
					instanceId: target.instanceId,
					runtimeId: target.runtimeId ?? null,
					sessionId: target.sessionId,
					busyStartedAt: busyStartedAtRef.current,
			...
			setChatRuntimeId(target.runtimeId ?? null);
		...
		const handleOpenDetailTask = import_react.useCallback((task) => {
			const { agentId, instanceId, runtimeId, sessionId } = task;
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
					...
					children: [chatShellError && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						initialRuntimeId: chatRuntimeId,
