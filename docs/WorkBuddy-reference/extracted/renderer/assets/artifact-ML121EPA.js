...
import { BV as isOverseas, CO as init_download, FV as init_environment, GD as useLoginErrorHandler, Hr as init_share_platform_helpers, LL as AdapterContext, Lr as generateShareQRCode, Ly as init_header_icon_dark, NG as accountService, PL as AccountContext, QW as WxaQrcodeSceneTypes, Rs as init_contexts, SO as fetchAndDownload, TV as getBrandName, VV as isWorkBuddy, WD as init_use_login_error_handler, WM as init_product_features, XL as init_header_workbuddy, ZN as useTaskShareFeature, ad as init_markdown_types, cL as init_useI18n, cW as init_common, ld as isMarkdownFile, od as isHtmlFile, sc as AuthProvider, uL as useTranslation, vL as init_dist, wL as useParams, wO as triggerDownload, zV as isLearnBuddy, zy as init_header_icon } from "./ui-docs-viewer-C2jT2eXi.js";
import { Ou as require_jsx_runtime, V as getArtifactFileIconKind, di as toast, kc as Button, ku as require_react, t as init_src } from "./lib-chat-ui-ChIVprRk.js";
import { d as getSMHHost, f as init_get_smh_host, i as init_adapters, n as savePathForLoginRedirect, r as createAgentAdapter, t as init_loginRedirect } from "./loginRedirect-NfbseEP4.js";
import { n as init_StatusPlaceholder, t as StatusPlaceholder } from "./StatusPlaceholder-DLNLGw91.js";
import { i as wechatmp_qr_code_default, n as init_miniprogram_qr_button, r as init_wechatmp_qr_code, t as MiniProgramQRButton } from "./miniprogram-qr-button-Dq3N-YhR.js";
import { a as ChatWithWorkBuddyButton, c as init_header_learnbuddy, i as init_OpenOrDownloadWorkBuddyButton, n as usePreviewDocumentTitle, o as init_ChatWithWorkBuddyButton, r as OpenOrDownloadWorkBuddyButton, t as init_usePreviewDocumentTitle } from "./usePreviewDocumentTitle-GnVYBon2.js";
import { n as init_get_source_url, t as getSourceUrl } from "./get-source-url-B3spBWxe.js";
import { n as isWXMiniProgram, t as init_ua } from "./ua-CptX92X0.js";
import { n as init_share_task_dialog, t as ShareTaskDialog } from "./share-task-dialog-BEy9ej8X.js";
import { a as HtmlPreview, i as init_MarkdownPreview, n as init_PreviewIframe, o as init_HtmlPreview, r as MarkdownPreview, t as PreviewIframe } from "./PreviewIframe-Cc_9H8Km.js";
...
var init_PreviewContent = __esmMin((() => {
	...
	PreviewContent = () => {
		...
		const isShareEnabled = useTaskShareFeature();
